...
function actor_binder:reinit()
	...
	local t = {
				...
				["take_item_from_ground"]	= bind_stalker_ext.actor_on_item_take_from_ground,
...
function actor_binder:save_state(m_data)
	...
	fallout_manager.save_state(m_data)
	ekidona_mags.save_state(m_data)
	inventory_weigth_patch.save_state(m_data)
	m_data.NPCPrecSpawn=xr_motivator.NPCPrecSpawn
	m_data.WeaponGrenadeAmmoDB=bind_weapon.WeaponGrenadeAmmoDB
	m_data.WeaponMainAmmoDB=bind_weapon.WeaponMainAmmoDB
...
function actor_binder:load_state(m_data)
	...
	fallout_manager.load_state(m_data)
	ekidona_mags.load_state(m_data)
	inventory_weigth_patch.load_state(m_data)
	xr_motivator.NPCPrecSpawn=(m_data.NPCPrecSpawn or {})
	bind_weapon.WeaponGrenadeAmmoDB=(m_data.WeaponGrenadeAmmoDB or {})
	bind_weapon.WeaponMainAmmoDB=(m_data.WeaponMainAmmoDB or {})
